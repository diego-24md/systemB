        ...
        <div class="col-side">
            ...
            <div class="notice-card">
                ...
                <div class="notice-rule">
                    ...
                    <span>Devuelve el libro el <strong>mismo día</strong>, antes de que termine el horario escolar.</span>
                </div>
                <div class="notice-rule">
                    <i class="fas fa-star"></i>
                    <span>Regrésalo en las <strong>mismas condiciones</strong> en que lo recibiste.</span>
                </div>
                <div class="notice-rule">
                    <i class="fas fa-hand"></i>
                    <span>Solo puedes tener <strong>un libro prestado</strong> a la vez.</span>
                </div>
                <div class="notice-rule">
                    <i class="fas fa-location-dot"></i>
                    <span>Entrega y devolución solo en la <strong>biblioteca del colegio</strong>.</span>
                </div>
            </div>
